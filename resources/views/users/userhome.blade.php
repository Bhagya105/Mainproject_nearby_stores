...
<div class="container1-page">
	...
	<section class="slide1 rs1-slick1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/yy.jpg);">
			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					...
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="images/gown.jpg" alt="IMG-BENNER">
				...
				<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="images/waa.jpg" alt="IMG-BENNER">
					...
					<!-- block1 -->
					<div class="block1 hov-img-zoom pos-relative m-b-30">
						<img src="images/shoes.jpg" alt="IMG-BENNER">
	...
	<!-- Banner2 -->
	<div class="banner2 bg5 p-t-55 p-b-55 bg-img1" style="background-image: url(images/ff.jpg);">
		<div class="container">
			<div class="flex-w flex-r-m flex-c-xl">
				<div class="p-t-15 p-b-15 w-size28">
					<div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm">
						<img src="images/sun.jpg" alt="IMG-BANNER">
